      ...
      <div className="px-20 lg:px-64">
        <div className="flex flex-col lg:flex-row justify-between gap-x-20 align-middle w-full">
          <div className="lg:w-1/2 w-full relative">
            ...
            <input
              className="w-full h-16 bg-blupayBlue-300 px-8 text-black text-sm mt-7 rounded-lg rounded-bl-lg focus:outline-none"
              id="fullname"
              type="fullname"
              name="fullname"
        ...
        <div className="w-full lg:mt-20 mt-14 relative">
          ...
          <textarea
            className="h-56 rounded-lg resize-none bg-blupayBlue-300 w-full p-8 mt-7 outline-none"
